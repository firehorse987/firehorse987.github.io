...
$(document).ready(function() {  "use strict";
  ...
  */ 
  ...
  function showSlide(requested){
    ...
    } else if(newSlide.hasClass('darkSlide')) {
	...
	if ( newSlide.hasClass('thirdslide') ){
		jQuery(".thirdslide ul.circle_list li").each(function(index) {    					
			var that = jQuery(this);                                               
			var t = setTimeout(function() { 						
				that.addClass('active');	
				if (index%2 == 0){
					that.find('.ns-content').parent().addClass("animated fadeInRight"); 	
					that.find('.ns-content').parent().css("visibility","visible"); 	
				}else{
					that.find('.ns-content').parent().addClass("animated fadeInLeft"); 	
					that.find('.ns-content').parent().css("visibility","visible"); 	
				} 
			}, 1500 * index);        
		}); 
		...
		jQuery(".thirdslide ul.circle_list li").each(function(index) {    					
			...
			var t = setTimeout(function() { 						
				...
				if (index%2 == 0){
					that.find('.ns-content').parent().removeClass("animated fadeInRight"); 	
					that.find('.ns-content').parent().css("visibility","hidden"); 	
				}else{
					that.find('.ns-content').parent().removeClass("animated fadeInLeft"); 	
					that.find('.ns-content').parent().css("visibility","hidden"); 	
				} 
			}, 0 * index);        
		}); 
	}                                                            
	if ( newSlide.hasClass('fiveslide') ){
		jQuery(".fiveslide ul.circle_list li").each(function(index) {   					
			var that = jQuery(this);
			var t = setTimeout(function() { 						
				that.addClass('active');	
				if (index%2 == 0){
